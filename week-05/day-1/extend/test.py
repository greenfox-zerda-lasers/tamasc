...
class TestExtend(unittest.TestCase):
    ...
    def test_add_6_and_3_is_9(self):
        self.assertEqual(extend.add(6, 3), 9)
    ...
    def test_median_four_is_4d5(self):
        self.assertEqual(extend.median([7,5,3,4]), 4.5)

    def test_median_seven_is_4d5(self):
        self.assertEqual(extend.median([7,5,3,4,7,3]), 4.5)
    ...
    def test_is_vovel_wrong_type(self):
    ...
    def test_translate_21(self):
        self.assertRaises(TypeError, extend.translate, 21)
